...
import { BookOpen, FolderOpen, GraduationCap, Home, Library, LifeBuoy, LogOut, Settings, Target, Users } from 'lucide-react';
...
const links = [
  ...
  { href: '/navigator', label: 'ФИПИ Navigator', icon: Library },
